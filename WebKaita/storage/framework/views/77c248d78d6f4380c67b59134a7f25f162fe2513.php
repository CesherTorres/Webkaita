...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card border-4 borde-top-primary shadow-sm py-2">
        <div class="card-body">
            <h6 class="text-uppercase fw-bold text-center">Resumen de inventario</h6>
            <table id="tinventario" class="table table-hover table-sm py-2" cellspacing="0" style="width:100%">
...
<?php echo $__env->make('templates.templateDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gilberto DS\Desktop\projectKaita\resources\views/inventario/index.blade.php ENDPATH**/ ?>