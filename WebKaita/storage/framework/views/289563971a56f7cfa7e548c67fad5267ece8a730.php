        ...
        <tr>
            ...
            <td style="width: 35%">
                <div class="card text-center border border-primary">
                    ...
                    <div class="py-1">
                        <span class="text-uppercase my-3"><?php echo e($salida->nro_serie_guia); ?> - <span class="text-red fw-bold lead">N° <?php echo e($salida->nguia); ?></span></span>
                    </div>
                </div>
            </td>
        </tr>
    ...
    <table class="w-100" style="font-size: 10px; ">
        ...
        <tbody class="alto">
            <?php $__currentLoopData = $detallesalida; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr> 
                    <td class=" align-top text-blue border-start" style="width: 10%"><?php echo e($item->codigo); ?></td>
                    <td class=" align-top text-blue border-start" style="width: 40%"><?php echo e($item->name); ?></td>
                    <td class=" align-top text-blue border-start" style="width: 10%"><?php echo e($item->orden_fabricacion); ?></td>
                    <td class=" align-top text-blue border-start" style="width: 10%"><?php echo e($item->cantidad); ?></td>
                    <td class=" align-top text-blue border-start" style="width: 10%"><?php echo e($item->medida); ?></td>
                    <td class=" align-top text-blue border-start border-end" style="width: 10%"><?php echo e($item->peso_total); ?></td>
                </tr>
...
</html><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/reportes/almacen/movimientos/guia_salida_pdf.blade.php ENDPATH**/ ?>