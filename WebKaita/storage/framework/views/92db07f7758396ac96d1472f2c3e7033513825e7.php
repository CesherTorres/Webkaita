...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($almacen,['route' => ['almacen.update', $almacen], 'autocomplete' => 'off', 'files' => true, 'method' => 'put']); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12 col-md-10 py-1">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" name="descripcion" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 160px"><?php echo e($almacen->descripcion); ?></textarea>
                ...
                <div class="col-9 col-md-2 py-1">
                    ...
                    <div class="card text-center imagecard rounded bg-light mb-0" style="height: 160px">  
                        <label for="uploadImage1" class=" my-auto text-center">
                            <img for="uploadImage1" id="uploadPreview1" alt="" class="py-auto rounded" style="width: 100%; height: 156px;" src="/images/planos/<?php echo e($almacen->plano); ?>">   
                        </label>
                    </div>
...
<?php echo $__env->make('templates.templateDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/configuracion-de-almacen/almacenes/edit.blade.php ENDPATH**/ ?>