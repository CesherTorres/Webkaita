                    ...
                    <?php echo method_field('put'); ?>
                        ...
                        <div class="form-group py-1">
                            ...
                            <select class="form-select form-select-sm" name="store_id" id="stores_id">
                                <option value="<?php echo e($area->almacen->id); ?>" disabled="disabled" selected="selected" hidden="hidden"><?php echo e($area->almacen->name); ?></option>
...
</div><?php /**PATH C:\Users\Gilberto DS\Desktop\projectKaita\resources\views/configuracion-de-almacen/areas/edit.blade.php ENDPATH**/ ?>