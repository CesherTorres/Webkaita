...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Encabezado -->
        <div class="row pt-5">
            ...
            <div class="col-lg-3 d-flex">
                <button class="btn btn-primary w-100 align-self-center text-white" data-bs-toggle="modal" data-bs-target="#createalmacen">
    ...
    <div class="card border-4 borde-top-primary shadow-sm py-2">
        <div class="card-body">
            ...
            <table id="talmacenes" class="table table-hover table-sm py-2" cellspacing="0" style="width:100%">
                <thead class="bg-light">
                    <tr>
                        <th class="h6">N°</th>
                        <th class="h6">Almacén</th>
                        <th class="h6">Tipo</th>
                        <th class="h6">Ubicación</th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $almacenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $almacen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="fw-light align-middle"><?php echo e($almacen->tipo); ?></td>
                                    <td class="fw-light align-middle"><?php echo e($almacen->direccion. '-' .$almacen->ubigeo->departamento.'/'.$almacen->ubigeo->provincia.'/'.$almacen->ubigeo->distrito); ?></td>
                                    <td class="align-middle">                                        
                                        <div class="text-center">
                                            <form method="POST" action="<?php echo e(route('almacen.destroy',$almacen->slug)); ?>" class="form-delete">
                                                ...
                                                <button type="button" class="btn btn-secondary text-white btn-sm " data-bs-toggle="modal" data-bs-target="#editalmacen<?php echo e($almacen->id); ?>"><i class="bi bi-pencil-square"></i></button>
                                                <button type="submit" class="btn btn-secondary text-white btn-sm"><i class="bi bi-trash-fill"></i></button>        
                                            </form>
                                        </div>      
                                    </td> 
                                </tr>
                                <?php echo $__env->make('configuracion-de-almacen.almacenes.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('configuracion-de-almacen.almacenes.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    $(document).ready(function() {
        var table = $('#talmacenes').DataTable( {
            responsive: true,
            "language": {
...
<?php echo $__env->make('templates.templateDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gilberto DS\Desktop\projectKaita\resources\views/configuracion-de-almacen/almacenes/index.blade.php ENDPATH**/ ?>