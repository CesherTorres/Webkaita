...
<body>
    ...
    <div class="text-center">
            ...
            <thead class="bg-secondary text-white">
                ...
                <tbody>
                    <?php $__currentLoopData = $salidas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salida): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->codigo); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->store->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->tipo->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->motivo->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->fecha); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->total_product); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($salida->nro_serie_guia.' - '.$salida->nguia); ?></td>
                        </tr> 
        ...
        <div class="text-end pt-3">
            <span>Total de movimientos de ingresos registrados: <span class="text-primary fw-bold" style="font-size: 25px"><?php echo e($salidas->count()); ?></span></span>
        </div>
    </div>
    <br>
...
</html><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/reportes/almacen/salidas-reportePdf.blade.php ENDPATH**/ ?>