...
<h6 class="text-uppercase fw-bold text-center">Lista de movimiento de ingreso</h6>
<table id="tmovimientosingreso" class="table table-hover table-sm py-2" cellspacing="0" style="width:100%">
...
<script>
    $(document).ready(function() {
        var table = $('#tmovimientosingreso').DataTable( {
            responsive: true,
            "language": {
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/movimientos/ingresos/table.blade.php ENDPATH**/ ?>