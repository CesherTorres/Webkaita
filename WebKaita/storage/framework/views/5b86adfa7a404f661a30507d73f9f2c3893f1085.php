...
<body>
        ...
        <tr>
            ...
            <td style="width: 35%">
                <div class="card text-center border border-primary">
                    ...
                    <span class="text-uppercase py-1">N°.- <?php echo e($ingreso->codigo); ?></span>
                </div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="width: 48%">
                <div class="clearfix">
                    ...
                    <span class="fw-normal float-end"><?php echo e($ingreso->almacenero->user->persona->name); ?></span>
                </div>
                <div class="clearfix">
    ...
    <table class="w-100" style="font-size: 13px; ">
        ...
        <tbody class="alto">
            <?php $__currentLoopData = $detalleingreso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr> 
                    ...
                    <td class=" align-top border-start" style="width: 10%"><?php echo e($item->precio_dt); ?></td>
                    <td class=" align-top border-start border-end" style="width: 10%"><?php echo e($item->cantidad*$item->precio_dt); ?></td>
                </tr>
...
</html><?php /**PATH /home/customer/www/neptundata.com/resources/views/reportes/almacen/movimientos/movimiento_ingreso_pdf.blade.php ENDPATH**/ ?>