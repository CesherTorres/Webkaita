        ...
        <table class="w-100" style="font-size: 13px;">
            <thead class="bg-secondary text-white">
                <tr>
                    ...
                    <th  class="border-0 py-2 border-secondary text-center">Departamento/Provincia/Distrito</th>
                    <th  class="border-0 py-2 border-secondary text-center">Ubicación</th>
                </tr>
            </thead>
                <tbody>
                    <?php $__currentLoopData = $almacenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $almacen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($almacen->id); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($almacen->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($almacen->ubigeo->departamento.'/'.$almacen->ubigeo->provincia.'/'.$almacen->ubigeo->distrito); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($almacen->direccion); ?></td>
                        </tr> 
