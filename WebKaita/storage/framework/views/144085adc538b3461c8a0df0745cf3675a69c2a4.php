                    ...
                    <?php echo csrf_field(); ?>
                        <div class="py-1">
                            ...
                            <select class="form-select select2 form-select-sm" name="store_id" id="stores_id" >
                                <option value="<?php echo e(old('store_id')); ?>" disabled="disabled" selected="selected" hidden="hidden"><?php echo e(old('store_id')); ?></option>
...
</div><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/configuracion-de-almacen/areas/create.blade.php ENDPATH**/ ?>