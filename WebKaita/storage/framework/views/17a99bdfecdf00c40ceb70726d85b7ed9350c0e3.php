...
<body>
    ...
    <div class="text-center">
            ...
            <thead class="bg-secondary text-white">
                ...
                <tbody>
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->id); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->codigo); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->marca->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->category->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->medida->name); ?></td>
                            <td class="border-bottom py-2 border-secondary text-center"><?php echo e($producto->precio); ?><</td>
                        </tr> 
        ...
        <div class="text-end pt-3">
            <span>Total de productos registrados: <span class="text-primary fw-bold" style="font-size: 25px"><?php echo e($productos->count()); ?></span></span>
        </div>
    </div>
    <br>
...
</html><?php /**PATH C:\Users\Gilberto DS\Documents\GitHub\projectKaita\resources\views/reportes/almacen/productos-reportePdf.blade.php ENDPATH**/ ?>