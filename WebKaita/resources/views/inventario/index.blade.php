                ...
                <div class="card-body pt-1 pb-0">
                    <div class="row align-items-center">
                        <div class="col-6 mr-2">
                            <div class="h6 mb-0 fw-bold text-primary text-uppercase">{{$store->name}}</div>
                            <div class="h6 fw-light text-muted">{{$store->direccion}}</div>
                            <a href="{{route('ingresos.store', $store->slug)}}" class="stretched-link"></a>
                        </div>
                        <div class="col-6">
                            <div class="h3 mb-0 fw-bold text-primary text-end text-uppercase">{{$store->total}}</div>
