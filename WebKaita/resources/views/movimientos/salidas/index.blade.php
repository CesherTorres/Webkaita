        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3">
                <div class="btn-group btn-group-sm w-100 mb-2 mb-md-0" role="group" aria-label="Basic radio toggle button group">
                   <a href="{{url('ingresos')}}" class="btn btn-outline-success">Ingresos</a>
                    <a href="{{url('salidas')}}" class="btn btn-success text-white">Salidas</a>
                </div>
            </div>
        </div>
    <!-- fin encabezado -->
        ...
        <div class="col-12 col-md-6">
            <div class="text-start text-md-end pb-3">
                <div class="btn-group me-2" role="group" aria-label="Basic example">
                    <a href="{{url('salidas/export/reporte-excel')}}" class="btn btn-dark border-white btn-sm px-4"><i class="bi bi-file-earmark-excel me-2"></i>CSV</a>
                    <a href="{{route('print-salidas.pdf')}}" target="bank" class="btn btn-dark border-white btn-sm px-4"><i class="bi bi-file-earmark-pdf me-2"></i>PDF</a>
                </div>
                <small>
        ...
        <div class="card-body" id="">        
            <div class="row pb-2">
                ...
                <div class="col-12 col-md-3">
                    <a href="{{url('salidas/create')}}" class="btn btn-primary btn-sm w-100 align-self-center text-white">
            ...
            <div class="">
                <table id="" class="display table table-hover table-sm py-2" cellspacing="0" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-light align-middle">{{$salida->codigo}}</td>
                            <td class="fw-light align-middle">{{$salida->tipo->name}}</td>
                            <td class="fw-light align-middle">{{$salida->motivo->name}}</td> 
                            <td class="fw-light align-middle">{{$salida->total_product}}</td>        
                            <td class="fw-light align-middle">{{$salida->nro_serie_guia.' - '.$salida->nguia}}</td>        
                            <td class="align-middle">                                        
                                <div class="text-center">
                                    <div class="d-flex">
                                        <a href="{{url("salidas/$salida->slug")}}" class="btn btn-secondary text-white btn-sm text-decoration-none me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver detalles"><i class="bi bi-eye-fill"></i></a>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{route('movimiento_salida.pdf', $salida)}}" target="bank"><i class="bi bi-file-pdf-fill me-2"></i>Imprimir movimiento</a></li>
                                            <li><a class="dropdown-item" href="{{route('guia_salida.pdf', $salida)}}" target="bank"><i class="bi bi-file-earmark-ruled-fill me-2"></i>Imprimir guía</a></li>
                                        </ul>
                                    </div>
                                </div>      
                            </td>
