        ...
        <tr>
            ...
            <td style="width: 35%">
                <div class="card text-center border border-primary">
                    ...
                    <span class="text-uppercase py-1">N°.- {{$salida->codigo}}</span>
                </div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="width: 48%">
                <div class="clearfix">
                    ...
                    <span class="fw-normal float-end">{{$salida->almacenero->user->persona->name}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold">FECHA:</span>
                    <span class="fw-normal float-end">{{$salida->fecha}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold">ORIGEN:</span>
                    <span class="fw-normal float-end">{{$salida->store->name}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold">DESTINO:</span>
                    <span class="fw-normal">{{$salida->destino_store}}</span>
                </div>
            </td>
            <td style="width: 4%">
            ...
            <td style="width: 48%" class="float-end">
                <div class="clearfix">
                    ...
                    <span class="fw-normal float-end">{{$salida->tipo->name}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold ">GUÍA DE REMISIÓN:</span>
                    <span class="fw-normal float-end">N° {{$salida->nro_serie_guia.' - '.$salida->nguia}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold ">TIPO MOVIMIENTO:</span>
                    <span class="fw-normal float-end">{{$salida->motivo->tipo_motivo}}</span>
                </div>
                <div class="clearfix">
                    <span class="fw-bold ">MOTIVO:</span>
                    <span class="fw-normal float-end">{{$salida->motivo->name}}</span>
                </div>
            </td>
        </tr>
        ...
        <tbody class="alto">
            @foreach($detallesalida as $item) 
                <tr> 
                    ...
                    <td class=" align-top border-start" style="width: 10%">{{$item->precio}}</td>
                    <td class=" align-top border-start border-end" style="width: 10%">{{$item->cantidad*$item->precio}}</td>
                </tr>
            @endforeach
            <tr>
