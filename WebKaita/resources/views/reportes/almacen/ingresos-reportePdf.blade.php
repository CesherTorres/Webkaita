            ...
            <thead class="bg-secondary text-white">
                ...
                <tbody>
                    @foreach($ingresos as $ingreso)
                        <tr>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->codigo}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->store->name}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->tipo->name}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->motivo->name}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->fecha}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->total_product}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$ingreso->nguia}}</td>
                        </tr> 
                    @endforeach
                </tbody>
        </table>
