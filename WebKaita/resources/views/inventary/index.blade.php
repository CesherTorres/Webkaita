...
<div class="row justify-content-between pb-4">
    <div class="col-lg-9 pt-4">
        <h3 class="text-secondary h2 text-uppercase fw-bold mb-0">Inventario</h3>
        <p class="text-muted">Productos que se tiene en el almacen</p>
    </div>
    <div class="col-lg-3 d-flex">
        <a href="/inventario/create" class="btn w-100 align-self-center text-white" style="background-color: rgb(60, 190, 48);">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">                                        
                                            <div class="text-center">
                                                <a class="btn btn-warning btn-sm text-white" href="#" role="button"><i class="bi bi-eye-fill"></i></a>
