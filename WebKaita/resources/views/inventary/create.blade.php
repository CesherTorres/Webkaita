...
<div class="card text-center mt-5">
    <div class="card-header text-white" style="background-color: rgb(60, 190, 48);">
    ...
    <div class="card-body">
        ...
        <div class="card mt-3 p-3">
            <div class="text-end mb-2">
                <button class="rounded-pill btn btn-primary"> + Agregar</button>
            </div>
            <div class="row">
        ...
        <div class="card border-4 borde-top-primary shadow-sm h-100 mt-4 py-2 mb-4">
            <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="row justify-content-end mt-3">
                    <div class="col-lg-4">
                        <button type="button" class="w-100 rounded-pill btn text-white mb-1" style="background-color: rgb(60, 190, 48);">Guardar</button>
                    </div>
                    <div class="col-lg-4">
