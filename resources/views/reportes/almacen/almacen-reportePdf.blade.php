            ...
            <thead class="bg-secondary text-white">
                ...
                <tbody>
                    @foreach($almacenes as $almacen)
                        <tr>
                            <td class="border-bottom py-2 border-secondary text-center">{{$almacen->id}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$almacen->name}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$almacen->ubigeo->departamento.'/'.$almacen->ubigeo->provincia.'/'.$almacen->ubigeo->distrito}}</td>
                            <td class="border-bottom py-2 border-secondary text-center">{{$almacen->direccion}}</td>
                        </tr> 
                    @endforeach
                </tbody>
        </table>
