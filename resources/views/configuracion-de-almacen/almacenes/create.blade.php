    ...
    <form class="form-group" method="POST" action="/almacen" enctype="multipart/form-data" autocomplete="off">      
        ...
        <div class="card border-4 borde-top-primary shadow-sm mt-2 m2-5">
            <div class="card-body">
                ...
                <input type="date" hidden name="fecha" value="{{$now->format('Y-m-d')}}">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 py-1">
                        ...
                        <input type="text" name="direccion" id="direccion_id" class="form-control fw-light form-control-sm" value="{{old('direccion')}}"  maxLength="100">
                        @error('direccion')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6 py-1">
                        ...
                        <input type="text" name="referencia" id="referencia_id" class="form-control fw-light form-control-sm" value="{{old('referencia')}}"  maxLength="100">
                        @error('referencia')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6 py-1">
                        ...
                        <select class="form-select form-select-sm select2" name="ubigeo_id" id="ubigeo_id">
                            <option value="{{old('ubigeo_id')}}" disabled="disabled" selected="selected" hidden="hidden"></option>
                    ...
                    <div class="col-12 col-md-10 py-1">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" name="descripcion" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 160px">{{old('descripcion')}}</textarea>
