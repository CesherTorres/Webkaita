...
{{-- Contenido --}}
  <form class="form-group" method="POST" action="/productos" enctype="multipart/form-data" autocomplete="off">      
    @csrf
    <input type="date" name="fecha" id="fecha_id" value="{{$now->format('Y-m-d')}}" class="float-end form-control form-control-sm hidden  fw-light" value="{{old('fecha')}}" maxLength="100">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-12 col-md-3 py-1">
              ...
              <input type="text" name="codigo" id="codigo_id" class="float-end form-control form-control-sm  fw-light" value="{{old('codigo')}}" maxLength="100">  
              @error('codigo')
          ...
          <div class="col-12 col-md-3 py-1">
            ...
            <select class="form-select select2 form-select-sm" name="tipo_id" id="tipos_id" >
              <option value="{{old('medida_id')}}" disabled="disabled" selected="selected" hidden="hidden">{{old('tipo_id')}}</option>
          ...
          <div class="col-12 col-md-4 py-1">
              ...
              <input type="text" name="name" id="name_id" class="float-end form-control form-control-sm  fw-light" value="{{old('name')}}" maxLength="100">  
              @error('name')
                  <small class="text-danger">{{$message}}</small>
              @enderror
          </div>
          ...
          <div class="col-12 col-md-3 py-1">
              ...
              <div class="input-group input-group-sm">
                <input type="number" name="temperatura" id="temperatura_id" class="float-end form-control form-control-sm  fw-light" value="{{old('temperatura')}}" maxLength="100">  
          ...
          <div class="col-12 col-md-5 py-1">
                  ...
                  <textarea class="form-control" name="descripcion" id="descripcion_id" placeholder="Escribe una descripción" style="height: 160px">{{old('descripcion')}}</textarea>
              @error('descripcion')
                  <small class="text-danger">{{$message}}</small>
              @enderror
          </div>
          <div class="col-12 col-md-5 py-1">
                  ...
                  <textarea class="form-control" name="beneficios" placeholder="escribe los beneficios de los productos" id="beneficios_id" style="height: 160px">{{old('beneficios')}}</textarea>
              @error('beneficios')
                  <small class="text-danger">{{$message}}</small>
              @enderror
          </div>
              ...
              @foreach($etiquetas as $etiqueta) 
                <div class="col-12 col-md-3 py-1">
                  <div class="form-check form-switch">
                    <input class="form-check-input" name="etiqueta[]" type="checkbox" value="{{$etiqueta->id}}" id="etiqueta{{$etiqueta->id}}">
